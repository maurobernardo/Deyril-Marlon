  ...
  en: {
    ...
    about: {
      ...
      highlights: {
        ...
        community: "Community engagement and knowledge transfer"
      },
      expertiseAreas: {
        remoteSensing: {
          title: "Remote Sensing",
          description: "GIS and Earth Observation Systems professional"
        },
        agricultureForest: {
          title: "Agriculture & Forest",
          description: "Biodiversity monitoring "
        },
        spatialData: {
          title: "Spatial Data",
          description: "Participatory mapping and data validation"
        },
        communityEngagement: {
          title: "Community Engagement",
          description: "Knowledge transfer and training"
        },
        mel: {
          title: "MEL",
          description: "Monitoring, Evaluation & Learning"
        },
        researchDesign: {
          title: "Research Design",
          description: "Lifelong learner through project experience"
        }
      },
    ...
    projects: {
      ...
      space4all: {
        ...
        methodology: "The study was conducted in a participatory format where the citizens were able to point and map the vulnerable areas of the city to climate hazards, especially flooding, including its depth level of the floods for the latest events. The applied methodology allowed to gather local experts and stakeholders experience regarding the city's vulnerability to climate hazards through workshops with governmental and municipality institutions, NGO, private sector and community-based organizations that are engaged on climate action, WASH and urban planning.",
        contribution: "Under the Data4MOZ umbrella, as remote sensing analyst in the institution, my role for Space4All went from the field data collect and model validation, conducting field validation sessions in Kisumo (Kenya) together with ITC-University of Twente members and leading the activities in Beira and Chimoio (Mozambique), engaging the local communities and stakeholders for model validation sessions and gather subsidies by field observations, transect walks and mapping informal settlements.",
        contact: "For further information:",
        contactPerson: "Lorraine Trento Oliveira (ITC-UT Space4all Researcher)"
      },
      bazaruto: {
    ...
    contact: {
      ...
      followUs: "Follow us",
      whatsappMessage: "Dear Marlon, I hope you are well. I came across your contact through your portfolio and would like to confirm if this is the appropriate channel to discuss the matter. Thank you in advance.",
      nome: "First Name",
      nomePlaceholder: "Enter your first name",
      apelido: "Last Name",
      apelidoPlaceholder: "Enter your last name",
      email: "Email",
      emailPlaceholder: "youremail@gmal.com",
      assunto: "Subject",
      assuntoPlaceholder: "What is this about?",
      contacto: "Phone",
      contactoPlaceholder: "+258 84 548 6656",
      mensagem: "Message",
  ...
  pt: {
    ...
    about: {
      ...
      highlights: {
        ...
        community: "Engajamento comunitário e transferência de conhecimento"
      },
      expertiseAreas: {
        remoteSensing: {
          title: "Sensoriamento Remoto",
          description: "Especialista em Sistemas SIG e Observação da Terra"
        },
        agricultureForest: {
          title: "Agricultura e Floresta",
          description: "Especialista em monitorização da biodiversidade"
        },
        spatialData: {
          title: "Dados Espaciais",
          description: "Mapeamento participativo e validação de dados"
        },
        communityEngagement: {
          title: "Engajamento Comunitário",
          description: "Transferência de conhecimento e formação"
        },
        mel: {
          title: "MEL",
          description: "Monitorização, Avaliação e Aprendizagem"
        },
        researchDesign: {
          title: "Design de Investigação",
          description: "Aprendiz ao longo da vida através da experiência de projetos"
        }
      },
    ...
    projects: {
      ...
      space4all: {
        ...
        date: "2024 - Em Curso",
        overview: "SPACE4ALL é um projeto da ITC-Universidade de Twente e NWO (Conselho Holandês de Investigação) que visa desvendar a vulnerabilidade climática de comunidades de favelas em grandes e cidades secundárias combinando métodos de Ciência Cidadã e Observação da Terra. Os métodos de Observação da Terra têm a vantagem de produzir dados físicos para grandes áreas e mostraram a sua capacidade de mapear os aspectos físicos das favelas. O projeto aborda as lacunas desenvolvendo uma metodologia inovadora de IA combinando dados de Ciência Cidadã e dados de Observação da Terra com dados de mudanças climáticas para localizar pontos críticos de pobres urbanos expostos a riscos relacionados com o clima (por exemplo, subida do nível do mar, tempestades, inundações, temperaturas extremas).",
        approach: "Esta abordagem inovadora teve como principal objetivo o desenvolvimento e treino de modelos de aprendizagem profunda para mapear o grau de vulnerabilidade das comunidades de favelas a riscos relacionados com o clima em grandes e cidades secundárias em África, para melhorar a precisão e a capacidade de alerta precoce de inundações do modelo.",
        locations: "O projeto foi realizado em cidades africanas, nomeadamente Kisumu e Nairobi no Quénia, Accra e Tema no Gana e por último Beira e Chimoio em Moçambique, em parceria com instituições africanas como Data4MOZ e Sdi Kenya.",
        methodology: "O estudo foi realizado num formato participativo onde os cidadãos puderam apontar e mapear as áreas vulneráveis da cidade a riscos climáticos, especialmente inundações, incluindo o seu nível de profundidade das inundações para os eventos mais recentes. A metodologia aplicada permitiu reunir a experiência de especialistas locais e partes interessadas sobre a vulnerabilidade da cidade a riscos climáticos através de workshops com instituições governamentais e municipais, ONG, setor privado e organizações comunitárias que estão envolvidas em ação climática, WASH e planeamento urbano.",
        contribution: "Sob o guarda-chuva da Data4MOZ, como analista de sensoriamento remoto na instituição, o meu papel para o Space4All foi desde a recolha de dados de campo e validação de modelos, realizando sessões de validação de campo em Kisumo (Quénia) juntamente com membros da ITC-Universidade de Twente e liderando as atividades em Beira e Chimoio (Moçambique), envolvendo as comunidades locais e partes interessadas para sessões de validação de modelos e reunir subsídios através de observações de campo, caminhadas de transecto e mapeamento de assentamentos informais.",
        contact: "Para mais informações:",
        contactPerson: "Lorraine Trento Oliveira (Investigadora ITC-UT Space4all)"
      },
      bazaruto: {
    ...
    skills: {
      ...
      mel: "Monitorização, Avaliação e Aprendizagem (MEL)",
      quantitativeQualitative: "Investigação Quantitativa e Qualitativa",
      naturalResourcesManagement: "Gestão de Recursos Naturais",
      sustainableLivelihood: "Sustentabilidade dos Meios de Subsistência",
      communityEngagement: "Envolvimento Comunitário",
      tools: "Ferramentas"
    },
    courses: {
      title: "Meus Cursos",
    ...
    publications: {
      ...
      readMore: "Ler Mais",
      publicationsList: {
        exposedUnmapped: "Expostos mas não mapeados? Evidência de exposição diferencial a inundações em áreas urbanas carentes usando ciência cidadã",
        validationLeafArea: "Validação de Índice de Área Foliar e Teor de Água na copa através de imagens sentinela-2 na cultura do milho (Zea Mays L.): Estudo de caso do distrito de vilankulo."
      },
      authors: {
        oliveiraEtAl: "Oliveira, L; Campomanes, E; Dijkstra, A; Belgiu, M; Adiku, P; Wanjiru, N; Lizian Onyango, L; Ibraimo, D; Flor, R; Van Den Bout, B; Zevenbergen, J & Kuffer, M",
        ibraimoMananze: "Ibraimo, D.M. & Mananze, S.E."
      ...
      journals: {
        researchSquare: "Research Square (Pré-impressão)",
        scienceCribe: "ScienceCribe"
      }
    },
    training: {
    ...
    contact: {
      title: "Contacte-me",
      description: "Entre em contacto comigo para colaborações, consultas ou apenas para dizer olá!",
      sendMessage: "Enviar mensagem",
      connectWithUs: "Conecte-se connosco",
      scheduleConsultation: "Agende uma consulta gratuita",
      followUs: "Siga-nos",
      whatsappMessage: "Prezado Marlon, espero que esteja bem. Cheguei ao seu contato por meio do seu portfólio e gostaria de confirmar se este é o canal adequado para tratarmos do assunto. Agradeço desde já.",
      nome: "Nome",
      nomePlaceholder: "Digite o seu nome",
      apelido: "Apelido",
      apelidoPlaceholder: "Digite o seu apelido",
      email: "Email",
      emailPlaceholder: "seuemail@gmail.com",
      assunto: "Assunto",
      assuntoPlaceholder: "Sobre o que é?",
      contacto: "Contacto",
      contactoPlaceholder: "+258 84 123 4567",
      mensagem: "Mensagem",
      mensagemPlaceholder: "Escreva a sua mensagem aqui...",
      send: "Enviar Mensagem",
      sending: "A enviar...",
      success: "Enviado!",
      successMessage: "Obrigado! A sua mensagem foi enviada com sucesso. Entrarei em contacto em breve.",
