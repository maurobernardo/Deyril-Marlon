      ...
      items: [
        {
          ...
          period: '2022 - Present',
          organization: 'Data4MOZ',
          location: 'Mozambique',
          description: 'Leading remote sensing analysis and GIS projects for natural resource management, biodiversity conservation, and climate vulnerability assessment across African countries.',
          highlights: [
            'Conducted field validation sessions in Kenya, Ghana, and Mozambique',
            'Developed AI models for climate vulnerability mapping',
            'Led participatory spatial data collection with local communities',
            'Managed multiple international research projects',
          ],
        },
        {
          type: 'work',
          typeLabel: 'Work Experience',
          title: 'Participatory Coastal Resources Mapping Project',
          period: 'Oct 2023 - Apr 2024',
          organization: 'Data4MOZ, Afrika Parks, ANAC',
          location: 'Bazaruto Archipelago, Mozambique',
          description: 'Conducted participatory spatial mapping at district, community, and island levels to map coastal resources and support biodiversity conservation efforts.',
          highlights: [
            'Engaged with fishing communities and district stakeholders',
            'Mapped critical coastal zones and biodiversity hotspots',
            'Supported community-based natural resource management',
          ],
        },
        {
          type: 'work',
          typeLabel: 'Work Experience',
          title: 'LUISA Project - Research & Data Collection',
          period: '2024 - Oct 2025',
          organization: 'Data4MOZ, ITC-UT, Boku University',
          location: 'Beira, Mozambique',
          description: 'Conducted mixed-methods research to support satellite-driven biomass monitoring platform through HANPP estimation for sustainable agriculture in Africa.',
          highlights: [
            'Led stakeholder consultations and key informant interviews',
            'Conducted focus group discussions with farmers and forestry operators',
            'Collected quantitative data on forestry and agricultural sectors',
          ],
        },
        {
          type: 'education',
          typeLabel: 'Education',
          title: 'BSc in Agricultural Engineering',
          period: '2019 - 2022',
          organization: 'Eduardo Mondlane University',
          location: 'Vilankulos, Inhambane Province',
          description: 'Specialized in agronomy with focus on remote sensing applications for crop monitoring and biophysical parameter validation.',
          highlights: [
            'Final year project on satellite imagery validation',
            'Developed expertise in GIS and Earth Observation systems',
          ],
        },
        {
          type: 'education',
          typeLabel: 'Education',
          title: 'UAV in Precision Agriculture',
          period: '2020',
          organization: 'University of Twente',
          location: 'Netherlands',
          description: 'Advanced training in UAV applications for precision agriculture and remote sensing data collection.',
        },
        {
          type: 'achievement',
          ...
          period: '2023 - 2024',
          description: 'Published research papers on remote sensing applications and biophysical parameter validation.',
          highlights: [
            'Co-authored paper on exposed and unmapped slums',
            'Published validation study on leaf area index estimation',
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          organization: 'Data4MOZ',
          location: 'Moçambique',
          description: 'Liderando análises de sensoriamento remoto e projetos de SIG para gestão de recursos naturais, conservação da biodiversidade e avaliação de vulnerabilidade climática em países africanos.',
          highlights: [
            'Conduziu sessões de validação de campo no Quênia, Gana e Moçambique',
            'Desenvolveu modelos de IA para mapeamento de vulnerabilidade climática',
            'Liderou coleta participativa de dados espaciais com comunidades locais',
            'Gerenciou múltiplos projetos de pesquisa internacionais',
          ],
        },
        {
          type: 'work',
          typeLabel: 'Experiência Profissional',
          title: 'Projeto de Mapeamento Participativo de Recursos Costeiros',
          period: 'Out 2023 - Abr 2024',
          organization: 'Data4MOZ, Afrika Parks, ANAC',
          location: 'Arquipélago de Bazaruto, Moçambique',
          description: 'Conduziu mapeamento espacial participativo nos níveis distrital, comunitário e insular para mapear recursos costeiros e apoiar esforços de conservação da biodiversidade.',
          highlights: [
            'Engajou-se com comunidades pesqueiras e partes interessadas distritais',
            'Mapeou zonas costeiras críticas e hotspots de biodiversidade',
            'Apoiou gestão comunitária de recursos naturais',
          ],
        },
        {
          type: 'work',
          typeLabel: 'Experiência Profissional',
          title: 'Projeto LUISA - Pesquisa & Coleta de Dados',
          period: '2024 - Out 2025',
          organization: 'Data4MOZ, ITC-UT, Boku University',
          location: 'Beira, Moçambique',
          description: 'Conduziu pesquisa de métodos mistos para apoiar plataforma de monitoramento de biomassa baseada em satélite através de estimativa HANPP para agricultura sustentável na África.',
          highlights: [
            'Liderou consultas com partes interessadas e entrevistas com informantes-chave',
            'Conduziu discussões de grupos focais com agricultores e operadores florestais',
            'Coletou dados quantitativos sobre setores florestais e agrícolas',
          ],
        },
        {
          type: 'education',
          typeLabel: 'Educação',
          title: 'Licenciatura em Engenharia Agronómica',
          period: '2019 - 2022',
          organization: 'Universidade Eduardo Mondlane',
          location: 'Vilankulos, Província de Inhambane',
          description: 'Especializado em agronomia com foco em aplicações de sensoriamento remoto para monitoramento de culturas e validação de parâmetros biofísicos.',
          highlights: [
            'Projeto de último ano sobre validação de imagens de satélite',
            'Desenvolveu expertise em sistemas de SIG e Observação da Terra',
          ],
        },
        {
          type: 'education',
          typeLabel: 'Educação',
          title: 'UAV em Agricultura de Precisão',
          period: '2020',
          organization: 'Universidade de Twente',
          location: 'Países Baixos',
          description: 'Formação avançada em aplicações de UAV para agricultura de precisão e coleta de dados de sensoriamento remoto.',
        },
        {
          type: 'achievement',
          typeLabel: 'Conquista',
          ...
          period: '2023 - 2024',
          description: 'Publicou artigos científicos sobre aplicações de sensoriamento remoto e validação de parâmetros biofísicos.',
          highlights: [
            'Co-autor de artigo sobre favelas expostas e não mapeadas',
            'Publicou estudo de validação sobre estimativa de índice de área foliar',
          ],
        },
      ],
    },
