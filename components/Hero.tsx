  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentTextIndex((prev) => 
        prev === t.home.rotatingTexts.length - 1 ? 0 : prev + 1
      )
    }, 4000)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-6">
            ...
            <div className="h-20 md:h-24 flex items-center justify-center lg:justify-start">
              <p className="text-lg md:text-xl lg:text-2xl text-gray-600 dark:text-gray-400 slide-fade-in">
            ...
            <div className="flex items-center justify-center lg:justify-start space-x-4 pt-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-12 h-12 rounded-full bg-gray-200 dark:bg-dark-card flex items-center justify-center text-gray-700 dark:text-gray-300 hover:bg-primary-500 hover:text-white dark:hover:bg-primary-500 transition-all duration-300"
            ...
            {/* CV Button */}
            <div className="pt-4">
              <button className="px-8 py-3 bg-primary-500 text-white rounded-lg font-medium hover:bg-primary-600 transition-colors shadow-lg hover:shadow-xl">
                {t.home.seeCV}
              </button>
            </div>
          </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
              <div className="absolute inset-0 bg-gradient-to-br from-primary-400 to-primary-700 rounded-full blur-3xl opacity-50"></div>
              <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-primary-500 shadow-2xl">
                ...
                {/* Placeholder for actual image - replace with Image component when image is available */}
                {/* <Image
                  src="/deyril-image.jpg"
                  alt={t.home.name}
                  fill
